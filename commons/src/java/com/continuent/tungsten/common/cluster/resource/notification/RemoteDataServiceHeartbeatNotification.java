...
public class RemoteDataServiceHeartbeatNotification extends ClusterResourceNotification
{
    /**
     * 
     */
    private static final long serialVersionUID = -1140652974780536320L;

    public RemoteDataServiceHeartbeatNotification(String clusterName, String memberName,
            String resourceName, ResourceState resourceState)
    {
        super(NotificationStreamID.MONITORING, clusterName, memberName,
                "INTERNAL", ResourceType.CLUSTER, resourceName, resourceState,
                null);
    }
