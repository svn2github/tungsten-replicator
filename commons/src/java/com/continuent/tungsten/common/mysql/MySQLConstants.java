...
public class MySQLConstants
{
    ...
    private static final HashMap<Integer, String> mapSqlStates                    = new HashMap<Integer, String>()
                                                                                 {
                                                                                     ...
                                                                                     {
                                                                                         put(ER_DBACCESS_DENIED_ERROR, "42000");
                                                                                         put(ER_TOO_MANY_USER_CONNECTIONS, "42000");
                                                                                     }
                                                                                 };
     ...
     * @param mysqlErrorCode the errorcode for which we want the corresponding SQLSTATE
     * @return String for the corresponding SQLSTATE. null if the SQLSTATE is not defined in our constants.
     */
