...
/**
 * Denotes a partitioner that depends on knowledge of queue state to make
 * partitioning decision.   
 * 
 * @author <a href="mailto:robert.hodges@continuent.com">Robert Hodges</a>
 * @version 1.0
 */
public interface StatefulPartitioner extends Partitioner
{
    /**
     * Sets metadata for partitions. 
     * 
     * @param partitions List of partition metadata instances
     */
