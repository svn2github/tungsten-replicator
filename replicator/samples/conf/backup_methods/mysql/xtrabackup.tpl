...
replicator.backup.agent.xtrabackup.options=user=${replicator.global.db.user}&password=${replicator.global.db.password}&host=${replicator.global.db.host}&port=${replicator.global.db.port}&directory=@{REPL_MYSQL_XTRABACKUP_TMP_DIR}&archive=@{REPL_MYSQL_XTRABACKUP_TMP_FILE}&mysqllogdir=@{APPLIER.REPL_MASTER_LOGDIR}&mysqllogpattern=@{APPLIER.REPL_MASTER_LOGPATTERN}&mysqldatadir=@{APPLIER.REPL_MYSQL_DATADIR}&mysqlibdatadir=@{APPLIER.REPL_MYSQL_IBDATADIR}&mysqliblogdir=@{APPLIER.REPL_MYSQL_IBLOGDIR}&mysql_service_command=@{APPLIER.REPL_BOOT_SCRIPT}&my_cnf=@{APPLIER.REPL_MYSQL_CONF}