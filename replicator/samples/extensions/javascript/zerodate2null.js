 ...
 *
 * JavaScript example for JavaScriptFilter. This filter turns MySQL 0 date
 * and timestamp values into NULL values.  It is necessary for MySQL to 
 * Oracle replication, since Oracle gets sick on 0 date values that MySQL
 * accepts. 
 *
